...
class ShowResourceTest {
    ...
    public void testControllerInvalidInput() throws Exception {
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        final LocalDate parse = LocalDate.parse("2024-02-17", formatter);
        Mockito.when(this.showService.fetchShowsForMovie("KOLKATA", "11111111-1111-1111-1111-111111111111", parse)).thenThrow(new InvalidInputException());
        this.mockMvc.perform(MockMvcRequestBuilders.get("/v1/shows/KOLKATA/11111111-1111-1111-1111-111111111111/2024-02-17")).andExpect(MockMvcResultMatchers.status().isNotFound()).andExpect(MockMvcResultMatchers.content().string("Invalid data provided"));
